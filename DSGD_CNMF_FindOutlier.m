...
%       X: Attribute matrix
%       W: Factor matrix containing information of node-community association (can be obtained by running DSGD_CNMF.py)
%       H: Factor matrix contatning attributal properties of communities (can be obtained by running DSGD_CNMF.py)
